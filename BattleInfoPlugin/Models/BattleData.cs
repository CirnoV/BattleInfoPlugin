...
namespace BattleInfoPlugin.Models
{
	public class BattleData : NotificationObject
	{
		...
		#region CellEvent 변경통지 프로퍼티
		private CellType _CellEvent;
		public CellType CellEvent
		{
