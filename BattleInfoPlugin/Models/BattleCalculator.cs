...
namespace BattleInfoPlugin.Models
{
	public class BattleCalculator
	{
		...
		private class CommonBattleData
		{
			...
			public Hougeki api_n_hougeki1 { get; set; }
			public Hougeki api_n_hougeki2 { get; set; }
		...
		public BattleCalculator Initialize(FleetData aliasFirst, FleetData aliasSecond, FleetData enemyFirst, FleetData enemySecond)
		{
			...
			{
				// 단일함대
				this.AliasFirstShips = new ShipBattleInfo[aliasShipsFirst.Length];
			...
			else
			{
				...
				// 연합함대
				this.AliasFirstShips = new ShipBattleInfo[aliasShipsFirst.Length];
				this.AliasSecondShips = new ShipBattleInfo[aliasShipsSecond.Length];
			...
			{
				// 단일함대
				this.EnemyFirstShips = new ShipBattleInfo[enemyShipsFirst.Length];
			...
			else
			{
				...
				// 연합함대
				this.EnemyFirstShips = new ShipBattleInfo[enemyShipsFirst.Length];
				this.EnemySecondShips = new ShipBattleInfo[enemyShipsSecond.Length];
		...
		/// 항공전 관련 계산
		/// </summary>
		private void UpdateAirBattle(Api_Kouku data, BattlePhase phase)
		{
			if (data == null) return;
		...
		/// </summary>
		private void UpdateSupport(Api_Support_Info data, BattlePhase phase)
		{
		...
		/// </summary>
		private void UpdateHougeki(Hougeki data, BattlePhase phase)
		{
			if (data == null) return;
		...
		/// </summary>
		private void UpdateHougeki(Hougeki data, BattlePhase phase, CombinedPhase combinedPhase, CombinedType combinedType = CombinedType.Default)
		{
			if (data == null) return;
		...
		/// 포격전, 선제대잠 관련 계산 (심해연합)
		/// </summary>
		private void UpdateHougeki(Hougeki data, BattlePhase phase, EachCombinedPhase combinedPhase = EachCombinedPhase.AllPhase, CombinedType combinedType = CombinedType.None)
		{
			if (data == null) return;
		...
		/// 야간 포격전 관련 계산
		/// </summary>
		private void UpdateMidnight(Midnight_Hougeki data, BattlePhase phase, int enemy_deck = 1)
		{
			if (data == null) return;
		...
		public void Update(sortie_battle data, ApiTypes_Sortie type)
		{
			this.Update(
				(ApiTypes)type,
		...
		public void Update(sortie_battle_midnight data, ApiTypes_SortieMidnight type)
		{
			this.Update(
				(ApiTypes)type,
				new CommonBattleData
		...
		public void Update(sortie_airbattle data, ApiTypes_SortieAirBattle type)
		{
			this.Update(
				(ApiTypes)type,
				new CommonBattleData
		...
		public void Update(combined_battle data, ApiTypes_CombinedBattle type)
		{
			this.Update(
				(ApiTypes)type,
				new CommonBattleData
		...
		public void Update(combined_battle_each data, ApiTypes_CombinedBattleEC type)
		{
			this.Update(
				(ApiTypes)type,
				new CommonBattleData
		...
		public void Update(combined_airbattle data, ApiTypes_CombinedAirBattle type)
		{
			this.Update(
				(ApiTypes)type,
				new CommonBattleData
		...
		public void Update(combined_battle_midnight data, ApiTypes_CombinedMidnight type)
		{
			this.Update(
				(ApiTypes)type,
				new CommonBattleData
		...
		public void Update(combined_battle_midnight_ec data)
		{
			this.Update(
		...
		public void Update(combined_battle_ec_nighttoday data)
		{
			this.Update(
